package io.brooklyn.provisioners;
...
public abstract class AbstractVirtualboxLiveTest {
    ...
    @Test(groups = {"Live"}, dependsOnMethods = "test_CentOS_6_3")
    ...
    public void test_CentOS_6_3() throws Exception {
        runTest(ImmutableMap.of("imageNameRegex", "centos","loginUser", "toor", "loginUser.password", "password"));
    }
