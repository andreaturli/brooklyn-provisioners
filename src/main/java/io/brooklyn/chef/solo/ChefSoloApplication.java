...
public class ChefSoloApplication extends AbstractApplication {

    private static final long serialVersionUID = -14811123920351157L;
    private static final Logger logger = LoggerFactory.getLogger(ChefSoloApplication.class);
    ...
    public ChefSoloApplication() {}
    public ChefSoloApplication(Map flags) { super(flags); }
    ...
    public static void main(String[] args) {
        ...
        ChefSoloApplication app = buildApplication(managementContext);
        startApplication(app, managementContext, applicationBrooklynProperties);
    }
    
    private static void startApplication(ChefSoloApplication app, ManagementContext managementContext, BrooklynProperties appProperties) {
    ...
    private static ChefSoloApplication buildApplication(ManagementContext managementContext) {

        Map flags = MutableMap.of(
                "mgmt", managementContext,
                "displayName", "Application");

        ChefSoloApplication app = new ChefSoloApplication(flags);
    ...
    private static Properties localProperties(String propertiesFilePath) {
        ...
        InputStream propsStream = new ResourceUtils(ChefSoloApplication.class.getClassLoader()).getResourceFromUrl(propertiesFilePath);
